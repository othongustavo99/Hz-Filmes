        ...
        if (state is HomeLoaded) {
          return RefreshIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                SliverAppBar(
                  floating: true,   // some ao rolar pra baixo
                  snap: true,       // volta rapidinho ao rolar pra cima
                ...
                // Conteúdo das seções
                SliverToBoxAdapter(  // ⚠️ corrija para SliverToBoxAdapter
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      FeaturedBanner(movies: state.trending.isNotEmpty ? state.trending : state.popular),
